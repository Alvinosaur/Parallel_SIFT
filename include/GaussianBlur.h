...
public:
    ...
    double convolve_half(Image & img, Image & new_img, float var, int n);
 ...
 //    double convolve_quarters_y(Image & img, float temp_temp[], Image & new_img, std::vector<float> distrib, float var, int n);
    ...
    double convolve_quarters_x(Image & img, float temp_temp[], Image & new_img, float var, int n);
    double convolve_quarters_y(Image & img, float temp_temp[], Image & new_img, float var, int n);
    double convolve_eighths_x(Image & img, float temp_temp[], Image & new_img, float var, int n);
    double convolve_eighths_y(Image & img, float temp_temp[], Image & new_img, float var, int n);
